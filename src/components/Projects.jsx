        ...
        <div style={{ 
          ...
          <div>
            <motion.h2 
              ...
              viewport={{ once: true }}
              style={{ fontSize: '3.5rem', marginBottom: '0.8rem', lineHeight: '1' }}
            >
            ...
            <motion.p 
              ...
              style={{ color: 'var(--text-secondary)', fontSize: '1.2rem', maxWidth: '600px' }}
            >
              Exploring the intersection of architectural backend and premium digital experiences.
            </motion.p>
          </div>
          ...
          <motion.div 
            ...
            style={{ fontSize: '0.85rem', fontWeight: '700', color: 'var(--accent-primary)', letterSpacing: '4px', textTransform: 'uppercase' }}
          >
            Digital Archive / 2024-2025
          </motion.div>
        </div>
